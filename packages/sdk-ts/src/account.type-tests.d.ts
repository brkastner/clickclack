import type { Channel, ChannelBotAssignment, ClickClackClient, User } from "./index";
...
type _LightAvatarPatchAllowed = Assert<
  IsAssignable<{ avatar_url_light: "https://example.com/light.png" }, UpdateMeInput>
>;
type _LightAvatarReadable = User["avatar_url_light"];
type _ChannelAssignmentsPreserved = Assert<
  IsAssignable<NonNullable<Channel["bot_assignments"]>[number], ChannelBotAssignment>
>;
