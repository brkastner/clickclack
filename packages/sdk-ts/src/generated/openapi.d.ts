...
export interface paths {
  ...
  "/api/channels/{channel_id}/bot-assignments/{bot_user_id}": {
    ...
    get?: never;
    put: operations["upsertChannelBotAssignment"];
    post?: never;
    delete: operations["deleteChannelBotAssignment"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
...
export interface components {
  schemas: {
    ...
    UpdateMeRequest: {
      ...
      handle?: string;
      /** @description Public image URL, or an empty string to clear it. Clearing it also clears avatar_url_light. */
      avatar_url?: string;
      /** @description Optional light-mode avatar URL, or an empty string to clear it. Requires avatar_url. */
    ...
    User: {
      ...
      deleted_at?: string;
      avatar_url: string;
      /** @description Optional light-mode avatar. Clients fall back to avatar_url when absent. */
      avatar_url_light?: string;
      /** Format: date-time */
      created_at: string;
      notification_settings?: components["schemas"]["NotificationSettings"];
    ...
    CreateBotRequest: {
      ...
      /**
       * Format: uri
       * @description Optional light-mode avatar. The primary avatar_url must be set first.
       */
      avatar_url_light?: string;
      token_name?: string;
      scopes?: string[];
    ...
    CreateThreadReplyRequest: {
      ...
      quoted_message_id?: string;
      nonce?: string;
      /** @description Number of uploads the client will attach after reply creation. */
      expected_attachment_count?: number;
    ...
    ChannelBotAssignmentResponse: {
      assignment: components["schemas"]["ChannelBotAssignment"];
...
export interface operations {
  ...
  upsertChannelBotAssignment: {
    ...
    requestBody?: never;
    responses: {
      /** @description Assigned a bot to the channel sidebar group */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": components["schemas"]["ChannelBotAssignmentResponse"];
        };
      };
    };
  };
  deleteChannelBotAssignment: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody?: never;
    responses: {
      /** @description Removed a bot from the channel sidebar group */
      200: {
        headers: {
          [name: string]: unknown;
        };
