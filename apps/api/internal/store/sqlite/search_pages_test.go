...
func TestSearchWorkspaceFTSMigrationPreservesAndScopesRows(t *testing.T) {
	...
	for _, name := range []string{"0035_bot_setup_requests.sql", "0037_managed_channels.sql", "0039_channel_display_title.sql", "0042_channel_bot_presentations.sql", "0043_channel_bot_assignments.sql", "0047_light_mode_avatars.sql"} {
