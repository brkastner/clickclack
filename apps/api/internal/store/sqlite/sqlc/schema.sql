...
CREATE INDEX idx_channel_bot_assignments_bot_user ON channel_bot_assignments(bot_user_id, channel_id);
...
CREATE INDEX idx_messages_direct_recency ON messages(direct_conversation_id, created_at DESC)
...
CREATE INDEX bot_runtime_statuses_target_idx ON bot_runtime_statuses (workspace_id, channel_id, direct_conversation_id, expires_at);
