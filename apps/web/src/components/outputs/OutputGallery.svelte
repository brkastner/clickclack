...
<style>
  ...
  .output-gallery__scrim { position: fixed; z-index: 10; inset: 0; display: grid; padding: calc(1rem + var(--safe-area-top)) calc(1rem + var(--safe-area-right)) calc(1rem + var(--safe-area-bottom)) calc(1rem + var(--safe-area-left)); background: rgb(0 0 0 / .7); place-items: center; }
