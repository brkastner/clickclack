...
function terminalTheme(): ITheme {
  ...
  return {
    ...
    black: color("--terminal-black", "#393552"),
    blue: color("--terminal-blue", "#9ccfd8"),
    brightBlack: color("--terminal-bright-black", "#908caa"),
    brightBlue: color("--terminal-bright-blue", "#9ccfd8"),
    brightCyan: color("--terminal-bright-cyan", "#ea9a97"),
    brightGreen: color("--terminal-bright-green", "#3e8fb0"),
    brightMagenta: color("--terminal-bright-magenta", "#c4a7e7"),
    brightRed: color("--terminal-bright-red", "#eb6f92"),
    brightWhite: color("--terminal-bright-white", "#e0def4"),
    brightYellow: color("--terminal-bright-yellow", "#f6c177"),
    cursor: color("--accent", "#c4a7e7"),
    cursorAccent: color("--bg", "#1f1d2e"),
    cyan: color("--terminal-cyan", "#ea9a97"),
    foreground: color("--text", "#e0def4"),
    green: color("--terminal-green", "#3e8fb0"),
    magenta: color("--terminal-magenta", "#c4a7e7"),
    red: color("--terminal-red", "#eb6f92"),
    selectionBackground: color("--accent-soft", "#403d52"),
    white: color("--terminal-white", "#e0def4"),
    yellow: color("--terminal-yellow", "#f6c177"),
  };
}
